...
public class ProductService {
	...
	@Value("${product.service.api.url.change-quantity-byid}")
	private String PRODUCT_SERVICE_URL_UPDATE_QUANTITY_BYID;
	...
	public String updateProductQuantiyById(Long productId, int quantity) {
		UriComponentsBuilder uriBuilder = UriComponentsBuilder
				.fromUriString(PRODUCT_SERVICE_URL_UPDATE_QUANTITY_BYID+productId)
