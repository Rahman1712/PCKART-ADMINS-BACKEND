...
public class OrderService {
	...
	@Value("${order.service.api.url.update_return_order}")
	private String ORDER_SERVICE_URL_UPDATE_RETURN_ORDER;
	...
	public String returnOrderConfirmed(Order order) {
		String returnMsg = webClient.put()
				.uri(ORDER_SERVICE_URL_UPDATE_RETURN_ORDER)
				.header(HttpHeaders.AUTHORIZATION,
						"Bearer "+jwtUsersService.generateToken(getAuthenticationUsername()))
				.header("Username", getAuthenticationUsername())
				.accept(MediaType.APPLICATION_JSON)
